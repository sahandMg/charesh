...
<div class="container" style="direction: rtl;padding-top: 30px;" id="app">

    @include('masterMatch.body',['tournament'=> $tournament,'route'=>$route])

    <br>
    <br>
    @if(count($errors->all()) || session('message'))
    ...
    <div class="card" style="margin-top: 20px;box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);z-index: 1;">
     <div>
      ...
      <img class="card-img-top rounded" src="storage/images/{{$tournament->path}}" alt="Card image cap" height="400px;">
      <div class="card-block">
       ...
       <div class="card-block">
         <div class="row">
           ...
           <div class="col-2">
             <h5>قوانین</h5>
             <a href="storage/pdfs/{{$tournament->rules}}" style="padding: 15px;"><i class="fa fa-file-pdf-o fa-lg" aria-hidden="true"></i></a>
           </div>
    ...
    <form style="padding-top: 20px;font-size: 20px;" method="post" action="{{route('matchRegister')}}" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div>
         <textarea name="additionalData" class="form-control" id="exampleTextarea" rows="10" placeholder="text editor"></textarea>
        </div>
       ...
       <button type="submit" class="btn btn-success" id="btnReg">ثبت نام</button>
               ...
               <form style="padding-top: 20px;font-size: 20px;" method="post" action="{{route('matchRegister')}}" enctype="multipart/form-data">
                   ...
                   {{--@if($tournament->matchType == "تیمی")--}}
                   {{--<div class="">--}}
                       {{--<label for="InputFile" class="col-4 col-form-label">لوگو (100px * 100px) </label>--}}
           ...
           @endif
               ...
               <a href="#">دریافت نسخه pdf بلیط مسابقه </a>
...
<script>
    ...
    vm = new Vue({
        ...
        created:function () {
                ...
                var i
                    for(i = 1 ; i<= {!! json_encode($tournament->minMember) !!} ; i++) {



                            $('<div id="in' + i + '" class="form-group row">  <label for="Name-input" class="col-2 col-form-label">  هم تیمی ' + i  + '   </label><div class="col-5"> <input @input="checkInput" placeholder="نام کاربری" name="teammate' + i + '" class="form-control" type="text"  id="number'+i+'">  </div></div>').insertBefore("#btnReg");
...
// var minTeamMember = 3 ;
 ...
 function addInput() {
  ...
  {
    g++;
      $('<div id="in' + g + '" class="form-group row">  <label for="Name-input" class="col-2 col-form-label">  هم تیمی ' + g  + '   </label><div class="col-5"> <input @iput="checkInput" placeholder="نام کاربری"  name="teammate' + g + '" class="form-control" type="text"  id="number'+g+'">  </div></div>').insertBefore("#btnReg");
  } else {
