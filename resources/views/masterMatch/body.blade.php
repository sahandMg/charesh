...
<ul class="nav nav-tabs" id="app">
    <li class="nav-item">
            ...
            <a  href="{{route('matchRegistered',['id'=>$tournament->id,'url'=>$tournament->code])}}" :class="RegClass">ثبت نام</a>
    ...
    {{--</li>--}}
    <li class="nav-item">
        <a   href="{{route('matchBracket',['id'=>$tournament->id,'url'=>$tournament->code])}}" :class="BracketClass" >براکت مسابقه</a>
    </li>
    <li class="nav-item">
        <a  href="{{route('matchTimeline',['id'=>$tournament->id,'url'=>$tournament->code])}}" :class="TimelineClass" >زمان بندی</a>
    </li>
    <li class="nav-item">
        <a   href="{{route('matchAttenders',['id'=>$tournament->id,'url'=>$tournament->code])}}" :class="attendersClass"> شرکت کنندگان </a>
    </li>
